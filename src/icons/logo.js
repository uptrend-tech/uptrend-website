...
const Logomark = ({ className, hidden }) => (
  <svg
    className={className}
...
const Wordmark = ({ className, hidden }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 1371 475"
    aria-hidden={hidden ? `true` : `false`}
    focusable={hidden ? `false` : `true`}
    aria-label={hidden ? `` : `Uptrend Wordmark`}
    fill="currentColor"
  >
    <text
      fill-rule="evenodd"
...
const DualLogo = ({ className, hidden }) => (
  <React.Fragment>
    <Logomark className={className} hidden={hidden} />
    <Wordmark className={className} hidden={hidden} />
  </React.Fragment>
)
...
const Logo = ({ className, hidden }) => (
  ...
  >
    <g fill="none" fill-rule="evenodd">
      <g fill="currentColor" transform="translate(50 19)">
        <path
          fill-rule="nonzero"
          d="M265,530 L0,265 L265,0 L530,265 L265,530 Z M62.9040404,265 L265,467.09596 L467.09596,265 L265,62.9040404 L62.9040404,265 Z"
        />
...
const LeoLogo = ({ className, hidden }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    ...
    fill="currentColor"
  >
    <g className="uptrend-logo">
      <g className="uptrend-logo__wrapper">
        <g className="uptrend-logo__inner">
        ...
        <g className="uptrend-logo__outer">
