...
const SEO = ({
  ...
  const orgaCreator = input => ({
    ...
    description: defaultDescription,
    url: siteUrl,
    email: `hello@uptrend.tech`,
    founder: `Uptrend Technology`,
    ...
    sameAs: [
      `https://github.com/uptrend-tech`,
      `https://twitter.com/uptrend_tech`,
    ],
  })
  ...
  return (
    <Helmet meta={meta}>
      ...
      <script type="application/ld+json">
        {JSON.stringify(orgaCreator(`identity`))}
      </script>
      <script type="application/ld+json">
        {JSON.stringify(orgaCreator(`creator`))}
      </script>
      {/* {newsletter ? (<script type="application/ld+json">{JSON.stringify(schemaNewsletter)}</script>) : (<script type="application/ld+json">{JSON.stringify(schemaHomepage)}</script>)} */}
